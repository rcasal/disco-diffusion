...
def main():
    ...
    args_m = {
        ...
        'n_batches':1,#args.n_batches if args.animation_mode == 'None' else 1,
        'batch_size':args.batch_size,
        'batch_name': args.batch_name,
        'steps': args.steps,
        'diffusion_sampling_mode': args.diffusion_sampling_mode,
        'width_height':  [args.width, args.heigth],#args.width_height,
        ...
        'video_init_path': None,#args.video_init_path,
        ...
        'translation_y': None,#args.translation_y,
        'translation_z': None,#args.translation_z,
        'rotation_3d_x': None,#args.rotation_3d_x,
        'rotation_3d_y': None,#args.rotation_3d_y,
        'rotation_3d_z': None,#args.rotation_3d_z,
        'midas_depth_model': None,#args.midas_depth_model,
        'midas_weight':None,# args.midas_weight,
        'near_plane': None,#args.near_plane,
        'far_plane': None,#args.far_plane,
        'fov': None,#args.fov,
        'padding_mode': None,#args.padding_mode,
        'sampling_mode': None,#args.sampling_mode,
        'angle_series':None,
        'zoom_series':None,
        ...
        'frames_scale': None,#args.frames_scale,
        'calc_frames_skip_steps': None,#args.calc_frames_skip_steps,
        'skip_step_ratio': None,#args.skip_step_ratio,
        'calc_frames_skip_steps': None,#args.calc_frames_skip_steps,
        ...
        'steps_per_checkpoint': None,#args.steps_per_checkpoint,
